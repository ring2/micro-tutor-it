...
import xyz.ring2.admin.portal.mapper.CourseContentMapper;
...
public class CourseContentServiceImpl extends ServiceImpl<CourseContentMapper, CourseContent> implements ICourseContentService {
 ...
 @Override
 public RestResult create(CourseContentDTO object) {
    CourseContent target = new CourseContent();
 ...
 @Override
 public RestResult update(CourseContentDTO object) {
    CourseContent target = new CourseContent();
    BeanUtil.copyProperties(object,target);
 ...
 public RestResult<Map<String, Object>> listByPage(QueryParam queryParam) {
    ...
    Page<CourseContent> page = new Page<>();
