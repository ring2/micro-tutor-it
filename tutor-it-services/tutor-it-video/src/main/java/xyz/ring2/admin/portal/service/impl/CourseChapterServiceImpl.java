...
import xyz.ring2.admin.portal.mapper.CourseChapterMapper;
...
public class CourseChapterServiceImpl extends ServiceImpl<CourseChapterMapper, CourseChapter> implements ICourseChapterService {
 ...
 @Override
 public RestResult create(CourseChapterDTO object) {
    CourseChapter target = new CourseChapter();
 ...
 @Override
 public RestResult update(CourseChapterDTO object) {
    CourseChapter target = new CourseChapter();
    BeanUtil.copyProperties(object,target);
 ...
 public RestResult<Map<String, Object>> listByPage(QueryParam queryParam) {
    ...
    Page<CourseChapter> page = new Page<>();
