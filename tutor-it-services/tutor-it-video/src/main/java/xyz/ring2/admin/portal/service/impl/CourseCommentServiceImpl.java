...
import xyz.ring2.admin.portal.mapper.CourseCommentMapper;
...
public class CourseCommentServiceImpl extends ServiceImpl<CourseCommentMapper, CourseComment> implements ICourseCommentService {
 ...
 @Override
 public RestResult create(CourseCommentDTO object) {
    CourseComment target = new CourseComment();
 ...
 @Override
 public RestResult update(CourseCommentDTO object) {
    CourseComment target = new CourseComment();
    BeanUtil.copyProperties(object,target);
 ...
 public RestResult<Map<String, Object>> listByPage(QueryParam queryParam) {
    ...
    Page<CourseComment> page = new Page<>();
