...
@RestController
@Slf4j
@RequestMapping("/portal/courseCategory")
public class CourseCategoryController {

    @Autowired
    ICourseCategoryService baseCourseCategoryService;

   /**
    *  新增
    */
    @PostMapping
    public RestResult create(@RequestBody @Valid CourseCategoryDTO object) {
        return baseCourseCategoryService.create(object);
    }
    ...
    */
    ...
    public RestResult delete(@PathVariable Integer id) {
        return baseCourseCategoryService.delete(id);
    }
    ...
    */
    @PutMapping
    public RestResult update(@RequestBody @Valid CourseCategoryDTO object) {
        return baseCourseCategoryService.update(object);
    }
    ...
    */
    ...
    public RestResult listByPage(@RequestParam Integer pageNum,@RequestParam Integer pageSize,@RequestParam String keyword) {
        ...
        return baseCourseCategoryService.listByPage(queryParam);
    }
}
