...
public class GoodsController {
    ...
    public RestResult saveGoodsCate(@RequestBody CourseCategory courseCategory) {
        boolean fieldsNotEmpty = FieldCheckUtils.isFieldsNotEmpty(courseCategory, CourseCategory::getParentId, CourseCategory::getCateName, CourseCategory::getLevel);
        if (fieldsNotEmpty) {
