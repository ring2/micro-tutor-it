...
public class MyGeneratorTemplate {
    ...
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/tutor-it-video?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
    ...
    private static StrategyConfig strategyConfig() {
        ...
        strategyConfig.setInclude(scanner("排除的表名，若有多个表以英文逗号分割").split(","));
    ...
    private static GlobalConfig globalConfig() {
        ...
        globalConfig.setOutputDir(projectPath + "/tutor-it-services/tutor-it-video/src/main/java");
        return globalConfig;
    }
    ...
    private static InjectionConfig injectionConfig() {
        String path = "/tutor-it-services/tutor-it-video/src/main/java/"+PARENT.replaceAll("\\.","/")+"/"+moduleName+"/entity/dto";
