...
public class MyGeneratorTemplate {
    ...
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/tutor-it-order?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
     ...
     * 乐观锁名称
     */
    private static final String OPTIMISTIC_LOCKING = "version";
    /**
     * 逻辑删除名称
     */
    private static final String LOGIC_DELETE = "deleted";

    /**
     * 父包名
     */
    private static final String PARENT = "tutor.it";
    ...
    private static StrategyConfig strategyConfig() {
        ...
        strategyConfig.setExclude(scanner("排除的表名，若有多个表以英文逗号分割").split(","));
    ...
    private static GlobalConfig globalConfig() {
        ...
        globalConfig.setOutputDir(projectPath + "/tutor-it-services/tutor-it-core-recommend/src/main/java");
        return globalConfig;
    }
    ...
    private static InjectionConfig injectionConfig() {
        String path = "/tutor-it-services/tutor-it-core-recommend/src/main/java/"+PARENT.replaceAll("\\.","/")+"/"+moduleName+"/entity/dto";
