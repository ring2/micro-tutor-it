 ...
 * @since 2020-05-25
 */
public interface IOrderCourseRelService extends IService<OrderCourseRel> {
  ...
  * @return
  */
  RestResult create(OrderCourseRelDTO object);
  ...
  * @return
  */
  RestResult update(OrderCourseRelDTO object);
